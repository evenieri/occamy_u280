...
# 
# Programs the SPI Flash of the U280 board with with two partitions and 
...
source occamy_u280_procs.tcl

# Parse arguments
if {$argc < 5} {
    error "usage: occamy_u280_flash.tcl HW_SERVER FPGA_PATH MCS OFFSET0 FILE0"
}
...
set occ_bit_stem occamy_u280/occamy_u280.runs/impl_1/occamy_u280_wrapper
