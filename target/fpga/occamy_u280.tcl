...
# Create block design
exec sed -i "s|CONFIG.Coe_File {.*}|CONFIG.Coe_File {$coe_path}|g" occamy_u280_bd.tcl
source occamy_u280_bd.tcl

# Add constraint files
add_files -fileset constrs_1 -norecurse occamy_u280_impl.xdc
import_files -fileset constrs_1 occamy_u280_impl.xdc
set_property used_in_synthesis false [get_files occamy_u280/occamy_u280.srcs/constrs_1/imports/fpga/occamy_u280_impl.xdc]
if { $EXT_JTAG } {
    add_files -fileset constrs_1 -norecurse occamy_u280_impl_ext_jtag.xdc
    import_files -fileset constrs_1 occamy_u280_impl_ext_jtag.xdc
    set_property used_in_synthesis false [get_files occamy_u280/occamy_u280.srcs/constrs_1/imports/fpga/occamy_u280_impl_ext_jtag.xdc]
} else {
...
# Generate wrapper
make_wrapper -files [get_files ./occamy_u280/occamy_u280.srcs/sources_1/bd/occamy_u280/occamy_u280.bd] -top
add_files -norecurse ./occamy_u280/occamy_u280.gen/sources_1/bd/occamy_u280/hdl/occamy_u280_wrapper.v
update_compile_order -fileset sources_1

# Create runs
generate_target all [get_files ./occamy_u280/occamy_u280.srcs/sources_1/bd/occamy_u280/occamy_u280.bd]
export_ip_user_files -of_objects [get_files ./occamy_u280/occamy_u280.srcs/sources_1/bd/occamy_u280/occamy_u280.bd] -no_script -sync -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] ./occamy_u280/occamy_u280.srcs/sources_1/bd/occamy_u280/occamy_u280.bd]

# Re-add occamy includes
set build occamy_u280
# Re-add occamy includes
export_ip_user_files -of_objects [get_ips occamy_u280_occamy_0] -no_script -sync -force -quiet
eval [exec sed {s/current_fileset/get_filesets occamy_u280_occamy_0/} define_defines_includes_no_simset.tcl]
...
# # For blockdesign-level signals: Use "set_property HDL_ATTRIBUTE.DEBUG $DEBUG [get_bd_nets ...]" in occamy_u280_bd.tcl
# if ($DEBUG) {
...
#     connect_debug_port u_ila_0/clk [get_nets [list occamy_u280_i/clk_wiz/inst/clk_core]]
...
#     set_property target_constrs_file occamy_u280/occamy_u280.srcs/constrs_1/imports/fpga/occamy_u280_impl.xdc [current_fileset -constrset]
#     if { $EXT_JTAG } {
#         set_property target_constrs_file occamy_u280/occamy_u280.srcs/constrs_1/imports/fpga/occamy_u280_impl_ext_jtag.xdc [current_fileset -constrset]
#     }
...
# set incremental_impl_dcp /usr/scratch2/wuerzburg/cykoenig/development/vivado_checkpoints/occamy_u280_wrapper_routed.dcp
