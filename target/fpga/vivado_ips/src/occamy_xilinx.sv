...
/*
  ...
  occamy_top i_occamy (
      ...
      .pcie_cfg_rsp_i  (ZERO),
      .hbi_wide_cfg_rsp_i (ZERO),
      .hbi_narrow_cfg_rsp_i (ZERO),
      .hbm_cfg_rsp_i (ZERO),
      .chip_ctrl_rsp_i (ZERO),
      .hbi_wide_req_i (ZERO),
      .hbi_wide_rsp_i (ZERO),
      .hbi_narrow_req_i (ZERO),
      .hbi_narrow_rsp_i (ZERO),
      .*
  );
*/
/*
  occamy_top i_occamy (
	...
	.chip_ctrl_rsp_i('0),
	.ext_irq_i(ext_irq_i),
	.hbm_0_req_o(), .hbm_0_rsp_i('0),
	.hbm_1_req_o(), .hbm_1_rsp_i('0),
	.hbm_2_req_o(), .hbm_2_rsp_i('0),
	.hbm_3_req_o(), .hbm_3_rsp_i('0),
	.hbm_4_req_o(), .hbm_4_rsp_i('0),
	.hbm_5_req_o(), .hbm_5_rsp_i('0),
	.hbm_6_req_o(), .hbm_6_rsp_i('0),
	.hbm_7_req_o(), .hbm_7_rsp_i('0),
	.hbi_wide_req_i('0),
	.hbi_wide_rsp_o(), 
	.hbi_wide_req_o(), 
	.hbi_wide_rsp_i('0),
